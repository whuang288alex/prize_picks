...
STATS = ["minutes", "points", "field_goals_made", "field_goals_attempted", "three_point_field_goals_made", "three_point_field_goals_attempted", "free_throws_made", "free_throws_attempted", "offensive_rebounds", "defensive_rebounds", "total_rebounds", "assists", "steals", "blocks", "turnovers"]
STATS_FOR_DISPLAY = ["Minutes", "Points", "Field Goals Made", "Field Goals Attempted", "3-Point Field Goals Made", "3-Point Field Goals Attempted", "Free Throws Made", "Free Throws Attempted", "Offensive Rebounds", "Defensive Rebounds", "Total Rebounds", "Assists", "Steals", "Blocks", "Turnovers"]
...
with team_stats_col:
    ...
    c.execute(f'''SELECT game_date, {TEAM_STATS[TEAM_STATS_FOR_DISPLAY.index(team_stats_category)]} from TeamStats WHERE team_id={team_id} AND {home_game_clause} ORDER BY game_date DESC LIMIT {team_last_n_games}''')
